  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-white px-6 py-16 text-center">
      <div className="w-full max-w-lg">
        {/* Icon */}
        <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-emerald-50 text-4xl">
          ✅
        </div>
        ...
        {/* Timeline card */}
        <div className="mt-10 rounded-3xl border border-zinc-100 bg-zinc-50 p-7 text-left">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
          ...
          <a
            href="/upload"
            className="rounded-full bg-zinc-950 px-6 py-3 text-sm font-semibold text-white transition hover:bg-zinc-700"
          >
            Order another frame
          </a>
        </div>
